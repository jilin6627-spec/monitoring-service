 ...
 * Architecture: edgetunnel → Cloudflare Tunnel (TCP) → Xray (ARGO_PORT) → Exit
 *
...
async function startserver() {
  ...
  await prepareBinaries(async () => {
    ...
    log('CONFIG', `edgetunnel 请使用: PROXYIP=${argoDomain}:443, PROXYIP_AUTH=${UUID}, PROXYIP_TYPE=vless`, 'info');
